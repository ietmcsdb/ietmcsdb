 ...
 * it provides a utility method to wrap an ObjectOutputStream to send serialized object and retrieve the response through an ObjectInputStream.</p>
 ...
 * @version 1.0
 */
public abstract class ObjectSender {
   ...
   */
  public abstract Response sendRequest(URLConnection connection,Command objectToSend) throws Throwable;
