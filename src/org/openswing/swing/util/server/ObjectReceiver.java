...
public abstract class ObjectReceiver {
   ...
   */
  public abstract Command getObjectFromRequest(HttpServletRequest request) throws Exception;
   ...
   */
  public abstract void setObjectToResponse(HttpServletResponse response,Object objectToSend) throws Exception;
