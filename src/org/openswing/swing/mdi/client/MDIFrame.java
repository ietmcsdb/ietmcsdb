...
public class MDIFrame extends JFrame implements BusyListener {
  ...
  protected static TreeMenu treeMenu = null;
...
//¼Ó°´Å¥
  ...
  private void jbInit() throws Exception  {
    ...
    DefaultTreeModel treefunctions = client.getTreeApplicationFunctions();
    if(treefunctions==null){
        System.out.println(ClientSettings.SHOW_SCROLLBARS_IN_MDI);
    ...
    if (client.viewFunctionsInTreePanel() && ((TreeNode)treefunctions.getRoot()).getChildCount()>0) {
      // add tree nodes...
      treeMenu = new TreeMenu(treefunctions);
